...
class CenterBar {
  ...
  handleSettings() {
    ...
    try {
      ...
      if (settingsBtn) {
        ...
        setTimeout(
          () => settingsBtn && settingsBtn.classList.remove("open-pulse"),
          600
        );
      }
    } catch (_) {}
    ...
    if (
      this.dispatch("centerbar:settings", {
        anchor:
          document.getElementById("cabSettings") ||
  ...
  handleSound() {
    ...
    if (
      this.dispatch("centerbar:sound", {
        anchor:
          document.getElementById("cabSound") ||
  ...
  handleMusic() {
    ...
    try {
      const btn = anchor;
      if (btn) {
        this.createZenBurst(btn, {
          tint: "var(--glow-color, rgba(99,102,241,0.65))",
        });
      }
    } catch (_) {}
  ...
  wireScrollHideCenterBar() {
    ...
    window.addEventListener("orientationchange", () =>
      setTimeout(ensureVisibleOnMobile, 150)
    );
  }
      ...
      if (window.lucide && typeof lucide.createIcons === "function") {
        ...
        if (cab) {
          ...
          if (cabMusicBtn && cabMusicBtn.classList.contains("is-playing")) {
            ...
            skipped = cabMusicBtn.querySelector(".lucide-icon")?.parentNode
              ? cabMusicBtn.querySelector(".lucide-icon")
              : null;
          ...
          if (skipped) {
            ...
            if (skipped.__cabNext)
              target.insertBefore(skipped, skipped.__cabNext);
      ...
      if (
        ...
        bus.addEventListener("music:hintStart", () => {
          ...
          if (!cabMusicBtn.classList.contains("hint")) {
            ...
            setTimeout(
              () => cabMusicBtn && cabMusicBtn.classList.remove("hint"),
              3000
            );
          }
        });
