...
class AffirmationManager {
    ...
    getAchievement(completedCount) {
        const achievements = {
            1: { title: "Mindful Beginning", message: "A gentle start to your day", icon: "🌱" },
            3: { title: "Gentle Progress", message: "Three mindful completions", icon: "🍃" },
            7: { title: "Weekly Rhythm", message: "A week of mindful moments", icon: "🕊️" },
            10: { title: "Daily Harmony", message: "Ten steps toward balance", icon: "✨" },
            15: { title: "Mindful Flow", message: "Fifteen moments of presence", icon: "🧘" },
            20: { title: "Peaceful Practice", message: "Twenty mindful completions", icon: "🌸" }
        };

        return achievements[completedCount] || {
