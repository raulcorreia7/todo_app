...
function ModalContent(props: ModalProps) {
  const [local] = splitProps(props, ['isOpen', 'onClose', 'title', 'children', 'size'])
        ...
        >
          <Show when={local.title}>
            <div class="modal-header">
              <h2 id="modal-title" class="modal-title">{local.title}</h2>
              <button class="modal-close" onClick={local.onClose} aria-label="Close modal">
